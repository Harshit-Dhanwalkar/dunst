...
static const struct setting allowed_settings[] = {
    ...
    },
    {
        .name = "fullscreen",
        .section = "*",
        .description = "This attribute specifies how notifications are handled "
                       "if a fullscreen window is focused. One of show, delay, "
                       "suppress or pushback.",
        .type = TYPE_CUSTOM,
        .default_value = "show",
        .value = NULL,
        .parser = string_parse_enum,
    ...
    },
    {
        ...
        .section = "*",
        .description = "Progress bar color override",
        .type = TYPE_COLOR,
        .default_value = "*",
        .value = NULL,
        .parser = NULL,
        .parser_data = NULL,
        .rule_offset = offsetof(struct rule, progress_bar),
    },
    {
    ...
    },
    {
        .name = "progress_bar_color",
        .section = "urgency_low",
        .description = "Progress bar color for notifications with low urgency",
        .type = TYPE_COLOR,
        .default_value = "#7f7fff",
        .value = &settings.colors_low.progress_bar,
        .parser = NULL,
        .parser_data = NULL,
    },
    {
        ...
        .section = "urgency_normal",
        .description =
            "Progress bar color for notifications with normal urgency",
        .type = TYPE_COLOR,
        .default_value = "#7f1fff",
        .value = &settings.colors_norm.progress_bar,
        .parser = NULL,
        .parser_data = NULL,
    },
    {
        ...
        .section = "urgency_critical",
        .description =
            "Progress bar color for notifications with critical urgency",
        .type = TYPE_COLOR,
        .default_value = "#4f1fff",
        .value = &settings.colors_crit.progress_bar,
        .parser = NULL,
        .parser_data = NULL,
    },
    {
    ...
    },
    {
        ...
        .section = "experimental",
        .description = "Pause notification timeout when mouse is over the "
                       "notification window. Only works on Wayland.",
        .type = TYPE_CUSTOM,
        .default_value = "false",
    ...
    },
    {
        ...
        .section = "experimental",
        .description =
            "Use PCRE regex for filtering rules (overrides enable_posix_regex)",
        .type = TYPE_CUSTOM,
        .default_value = "false",
